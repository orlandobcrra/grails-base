...
class UsuarioController {
    ...
    def save() {
        ...
        usuarioInstance.accountExpired=false
        usuarioInstance.accountLocked=false
        usuarioInstance.passwordExpired=false
        
        if (!usuarioInstance.save(flush: true)) {
            render(view: "create", model: [usuarioInstance: usuarioInstance])
            return
        }
        if(usuarioInstance.tipoRol.equals("Cliente")){
            Rol rol=Rol.findByAuthority("ROLE_USUARIO")
            UsuarioRol.create usuarioInstance, rol, true
        }
        if(usuarioInstance.tipoRol.equals("Coordinador")){
            Rol rol=Rol.findByAuthority("ROLE_USUARIO")
            UsuarioRol.create usuarioInstance, rol, true
        }
